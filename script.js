...
async function fetchData() {
    try {
        const response = await fetch("https://61937d32d3ae6d0017da85fd.mockapi.io/users", )
        ...
        tableList.addEventListener('click', (e) => {
            ...
            if (deleteButtonIsPressed) {
                if (confirm('Are you sure to delete this record?')) {
                    fetch(`https://61937d32d3ae6d0017da85fd.mockapi.io/users/${idValue}`, {
                            method: "DELETE",
                        })
                        .then(res => res.json())
...
postData.addEventListener('submit', async function (e) {
    ...
    if (isEdit == true) {
        try {
            await fetch(`https://61937d32d3ae6d0017da85fd.mockapi.io/users/${idValues.value}`, {
                    method: "PUT",
                    headers: {
        ...
        try {
            await fetch("https://61937d32d3ae6d0017da85fd.mockapi.io/users", {
                    method: "POST",
                    headers: {
                        "Content-type": "application/json"
                    },
